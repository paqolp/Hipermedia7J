            ...
            <div class="column is-9">
                <div class="columns">
                    <div class="column is-6">
                        ...
                        <form action="./php/agregarEquipo.php" method="post">
                        ...
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="content">
                                    <div class="control has-icons-left has-icons-right">
                                        <input id="fridaEmail" name="miembros" class="input is-large" type="text" placeholder="" required>
                         ...
                         <div class="card">
                            ...
                            <div class="card-content">
                                <div class="content">
                                    <div class="control has-icons-left has-icons-right">
                                        <input id="fridaEmail" name="mentor" class="input is-large" type="text" placeholder="" required>
