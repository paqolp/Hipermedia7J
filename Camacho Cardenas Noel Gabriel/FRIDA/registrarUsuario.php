                    ...
                    <div class="column is-6">
                            ...
                            <div class="card-content">
                                <div class="content">
                                    <div class="control has-icons-left has-icons-right">
                                        <input class="input is-large"  name="rol"type="text" placeholder="" required>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="content">
                                    <div class="control has-icons-left has-icons-right">
                                        <input class="input is-large"  name="nombre"type="text" placeholder=""required>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="content">
                                    <div class="control has-icons-left has-icons-right">
                                        <input id="fridaEmail" name="correo" class="input is-large" type="text" placeholder="" required>
                        ...
                        <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="content">
                                        <div class="control has-icons-left has-icons-right">
                                            <input class="input is-large" name="contrasena" type="text" placeholder="" required>
                            ...
                            <!-- <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="content">
                                        <div class="control has-icons-left has-icons-right">
                                            <input id="fridaPass" class="input is-large" type="text" placeholder="">
                        ...
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="content">
                                    <div class="control has-icons-left has-icons-right">
                                        <input class="input is-large" name="fecha_nac" type="text" placeholder="DD/MM/AAAA" required>
                        ...
                        <div class="card">
                            <header class="card-header">
                                <p class="card-header-title">
                                        Escuela de procedencia / Institución / Empresa:
                                </p>
                            </header>
                            <div class="card-content">
                                <div class="content">
                                    <div class="control has-icons-left has-icons-right">
                                        <input class="input is-large" name="lugar_procedencia" type="text" placeholder="">
                        ...
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="content">
                                    <div class="control has-icons-left has-icons-right">
                                        <input class="input is-large" name="telefono" type="tel" placeholder="" required>
                        ...
                        <div class="card">
                            <header class="card-header">
                                <p class="card-header-title">
                                    Área de conocimiento, solo mentores y lideres f :
                                </p>
                            </header>
                            <div class="card-content">
                                <div class="content">
                                    <div class="control has-icons-left has-icons-right">
                                        <input class="input is-large" name="area_conocimiento" type="text" placeholder="" >
